...
var $author$project$Test$init = {z: ''};
...
var $author$project$Test$Change = $elm$core$Basics$identity;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$reverse(model.z))
					]))
			]));
};
var $author$project$Test$main = $elm$browser$Browser$sandbox(
	{au: $author$project$Test$init, aC: $author$project$Test$update, aD: $author$project$Test$view});
var $author$project$Main$inital_value = 0;
var $author$project$Main$init = $author$project$Main$inital_value;
	...
	function (msg, model) {
		switch (msg) {
			...
			case 1:
				return model - 1;
			default:
				return $author$project$Main$inital_value;
		}
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(0))(0)},'Test':{'init':$author$project$Test$main(
